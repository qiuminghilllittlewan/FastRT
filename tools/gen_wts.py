...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        default='/home/user/project_ws/src/reid_ros/scripts/fast-reid/configs/VERIWild/bagtricks_R50-ibn.yml',
        metavar="FILE",
        help="path to config file",
    )
    parser.add_argument(
        "--wts_path",
        default='/home/user/project_ws/src/reid_ros/scripts/fast-reid/projects/FastRT/outputs/trt_model_file/veri_wild_bot_R50_ibn.wts',
